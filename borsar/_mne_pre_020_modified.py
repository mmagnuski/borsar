...
# TODO: check when interp is returned in mne _plot_topomap - from that
#       moment we can use the version of plot_topomap that is in
#       _mne_020_modified
def plot_topomap(data, pos, vmin=None, vmax=None, cmap=None, sensors=True,
    ...
    return _plot_topomap(data, pos, vmin, vmax, cmap, sensors, res, axes,
                         ...
                         head_pos, onselect, extrapolate, border)[:3]
